...
export function formatTimestamp(date: Date) {
	...
	const monthInFormattedTimestamp = (date.getMonth() + 1)
		.toString()
		.padStart(2, "0");
	...
	const hourInFormattedTimestamp = hours.toString().padStart(2, "0");
	const minuteInFormattedTimestamp = minutes.toString().padStart(2, "0");
	const secondInFormattedTimestamp = seconds.toString().padStart(2, "0");
